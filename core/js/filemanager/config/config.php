...
$upload_dir = '/testedit/files/upload/'; // path from base_url to base of upload folder (with start and final /)
...
$ext_video = array(); // $ext_video = array('mov', 'mpeg', 'mp4', 'avi', 'mpg','wma',"flv","webm"); //Video 
$ext_music = array(); // $ext_music = array('mp3', 'm4a', 'ac3', 'aiff', 'mid','ogg'); //Audio
